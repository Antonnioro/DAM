...
public class Ejercicio10_LeerDosFicherosV2 {

	public static void main(String[] args) {

		try {
			BufferedReader br1 = new BufferedReader(new FileReader("c://prueba//malaga.txt"));
			BufferedReader br2 = new BufferedReader(new FileReader("c://prueba//Union.txt"));

			BufferedWriter bw = new BufferedWriter(new FileWriter("c://prueba//Union3.txt"));
